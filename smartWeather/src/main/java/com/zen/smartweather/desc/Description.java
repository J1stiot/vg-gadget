package com.zen.smartweather.desc;
...
public class Description {
    ...
    // Weather Device's description id
    public static final String ID = "to4m1eez4cpv";

    // Trigger
    public static final String TRIGGER_FORECAST = "forecast";

    // Attributes
    public static final String ATTR_AREA_ID = "areaId"; //区域ID
    public static final String ATTR_AREA_CN = "area_cn";
    public static final String ATTR_AREA_EN = "area_en";

    public static final String ATTR_CITY_CN = "city_cn";
    public static final String ATTR_CITY_EN = "city_en";

    public static final String ATTR_STATE_CN = "state_cn";
    public static final String ATTR_STATE_EN = "state_en";

    public static final String ATTR_COUNTRY_CN = "country_cn";
    public static final String ATTR_COUNTRY_EN = "country_en";
    ...
    public static final String ATTR_DAY_1_NIGHT_WIND_FORCE = "d1NightWindForce";
    public static final String ATTR_DAY_1_SUNRISE = "d1Sunrise";
    ...
    public static final String ATTR_DAY_2_NIGHT_WIND_FORCE = "d2NightWindForce";
    public static final String ATTR_DAY_2_SUNRISE = "d2Sunrise";
    ...
    public static final String ATTR_DAY_3_NIGHT_WIND_FORCE = "d3NightWindForce";
    public static final String ATTR_DAY_3_SUNRISE = "d3Sunrise";
